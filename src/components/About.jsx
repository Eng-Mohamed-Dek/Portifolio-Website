    ...
    <div className='scroll-mt-32 text-center flex flex-col items-center mt-32 mb-32 md:gap-8 px-7 ' id='About'>
      ...
      <ScrollTrigger onEnter={() => setCount(true)} onExit={() => setCount(false)}>
        <div id="services" class="w-full md:text-center text-left md:px-[20%] mt-5 text text-[16px] font-normal">
          Waxaan ahay arday bartay IT-skills ku nool Magaaladda Muqdisho, Waxaan bilaabay barashada IT-ka june, 2023. Anigoo aad u xiisanaya siinaya ahmiyad weyn siiyay. Waxaan sidoo kale bilaabay Jaamacad oo run ahaantii aan isuu gelin inaan dhamaystiro sababo dhaqaalo awgeed iiguna kala go'day semester 3 balse maan joojin barashada IT-ka ilaa aan ka go'aan saday inaan ku shaqeeyo oo aan ku guuleystay qeybteydii ugu horeysay ee Graphic Design kadibna waxaan Aasaasay Hirkaab Academy Dec, 2023 oo laga barto xirfadaha kala graphic design, video editing, web design iyo web development, waxaan sidoo kale lasoo shaqeeyayaa <a href="www.gellebashir.com" className='text-blue-600'>Gellebashir Academy</a> iyo <a href="https://baroxirfad.com/?s=Eng+Mohamed+Dek&post_type=courses" className='text-blue-600'>Baroxirfad</a> oo aan ka bixiyo Fullstack Web Development Courses. To See More Visit My Social Media Platforms 👇.
        </div>
